...
export default function MangaClient({ slug, manga, chapters }: { slug: string, manga: any, chapters: any[] }) {
  ...
  // FITUR ANTI-CACHE: Otomatis me-load ulang data saat halaman ini diakses kembali
  useEffect(() => {
    ...
    // Trik tambahan agar refresh terjadi otomatis saat tab aktif kembali (Habis klik tombol Back)
